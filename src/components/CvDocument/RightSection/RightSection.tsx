...
const RightSection: React.FC<RightSectionProps> = ({ projects, workExperienceTitle }) => {
  return (
    <View style={[styles.container]}>
      ...
      <Text style={styles.aboutMeDescription}>I am a senior AI Engineer / .NET Full-Stack / developer / contractor / freelancer with <Text style={{fontWeight: 'black'}}>9+ years of experience</Text>, only interested in remote work.</Text>

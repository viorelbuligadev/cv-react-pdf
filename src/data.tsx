...
export const projectsByName = {
  mosaic: {
    ...
    from: 'November 2025',
    to: 'May 2026',
    title: 'Senior .NET Cloud Engineer',
    ...
    achievements: [
      <><Text isBold>Upgraded production EC2 instances to a supported OS baseline</Text>  using a repeatable Terraform-based migration strategy, achieving zero data loss and zero downtime for hosted workloads while eliminating end-of-life security exposure.</>,
    ...
    skills: ['C#', '.NET 10', 'Azure DevOps', 'Azure', 'Docker', 'CI/CD pipelines and templates', 'Pulumi', 'Terraform', 'AWS(EC2, RDS, ECS, IAM, VPC, ECR, ALB, SQS, CloudWatch, CloudFront)', 'PowerShell', 'YAML'],
  },
  umm: {
    ...
    skills: ['C#', '.ASP.NET Core', 'Angular', 'Azure Cloud', 'Azure DevOps', 'Terraform', 'Docker', 'Container Apps', 'Azure SQL Database', 'Service Bus', 'PowerShell', 'YAML'],
  },
  etrm: {
    ...
    skills: ['C#', '.NET 8', 'ASP.NET Core 8', 'Azure Functions', 'Azure CosmosDB', 'Blob Storage', 'Service Bus', 'Kafka', 'Angular', 'Python', 'Event-Driven Architecture', 'DDD', 'Azure DevOps'],
  },
  costko: {

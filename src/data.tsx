...
export const projectsByName = {
  ...
  umm: {
    ...
    skills: ['C#', '.ASP.NET Core', 'Angular', 'Azure Cloud', 'Azure DevOps', 'Terraform', 'Docker', 'Container Apps', 'Azure SQL Database', 'Service Bus', 'PowerShell', 'YAML', 'GitHub Copilot'],
  },
  etrm: {
    ...
    skills: ['C#', '.NET 8', 'ASP.NET Core 8', 'Azure Functions', 'Azure CosmosDB', 'Blob Storage', 'Service Bus', 'Kafka', 'Angular', 'Python', 'FastAPI', 'Event-Driven Architecture', 'Azure Event Hub', 'Kafka', 'DDD', 'Azure DevOps'],
  },
  costko: {

...
import {aiTools, certifications, contacts, ContactType, education, profilePhoto, skills} from "../../../data";
  ...
  return (
    <View style={[styles.container]}>
      <View style={styles.profilePictureContainer}>
        ...
        <Image style={styles.profilePicture} src={profilePhoto} />
      </View>
      ...
      <LeftSectionPanel title="AI tools">
        {aiTools.map((tool) => (
          <Text key={tool} contrast>{tool}</Text>
        ))}
      </LeftSectionPanel>

      <LeftSectionPanel title="Skills">
        {skills.map((skill) => (
          <SkillItem key={skill.name} years={skill.years} name={skill.name} />
        ))}
      </LeftSectionPanel>

      <LeftSectionPanel title="Certifications">
        {certifications.map((certification) => (
          <Text key={certification} contrast>{certification}</Text>
        ))}
      </LeftSectionPanel>

      <LeftSectionPanel title="Education">
        <Text contrast isBold>{education.institution}</Text>
        <Text contrast>{education.degree}</Text>
        <Text contrast>{education.location}</Text>
      </LeftSectionPanel>
    </View>
  )
}
